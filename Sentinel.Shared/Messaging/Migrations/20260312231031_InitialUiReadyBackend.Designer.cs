...
namespace Sentinel.Shared.Messaging.Migrations
{
    ...
    [Migration("20260312231031_InitialUiReadyBackend")]
    partial class InitialUiReadyBackend
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sentinel.Shared.Messaging.ComplianceLedgerEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("HandlerDurationMs")
                        .HasColumnType("integer")
                        .HasColumnName("handler_duration_ms");
                    ...
                    b.HasIndex("MessageId")
                        .IsUnique()
                        .HasDatabaseName("ix_events_message_id");

                    b.HasIndex("ProcessedAtUtc")
                        .HasDatabaseName("ix_events_processed_at_utc");

                    b.HasIndex("RequestId")
                        .HasDatabaseName("ix_events_request_id");

                    b.ToTable("events", "compliance_ledger");
                });

            modelBuilder.Entity("Sentinel.Shared.Messaging.OutboxDispatchRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_dispatch_records");

                    b.HasIndex("CreatedAtUtc")
                        .HasDatabaseName("ix_dispatch_records_created_at_utc");

                    b.HasIndex("RequestId")
                        .HasDatabaseName("ix_dispatch_records_request_id");

                    b.ToTable("dispatch_records", "masstransit");
                });
